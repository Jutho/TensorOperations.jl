...
@testset "methods" verbose = true begin
    ...
    @testset "tensortrace!" begin
        ...
        @test B ≈ Bcopy
        @test_throws TensorOperations.IndexError tensortrace!(B, A, [:a, :b, :c], [:b, :c],
                                                              α,
                                                              β)
    ...
    @testset "tensorcontract!" begin
        ...
        tensorcontract!(C, [:d, :a, :e], A, [:a, :b, :c, :d], 'N', B, [:c, :e, :b], 'C', α,
                        β)
        @test C ≈ Ccopy
        @test_throws IndexError tensorcontract!(C, [:d, :a, :e], A,
                                                [:a, :b, :c, :a], 'N', B,
                                                [:c, :e, :b], 'N', α, β)
        @test_throws IndexError tensorcontract!(C, [:d, :a, :e], A, [:a, :b, :c, :d], 'N',
                                                B,
                                                [:c, :b], 'N', α, β)
